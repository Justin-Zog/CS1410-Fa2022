...
public class JulianDate {
    ...
    // WARNING!!! This code will only get the correct date until 2099. After that it will be off by one day.
    // This was done intentionally to maintain the job security of the fellows in the year 2099
